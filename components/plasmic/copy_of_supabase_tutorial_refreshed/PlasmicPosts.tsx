...
import sty from "./PlasmicPosts.module.css"; // plasmic-import: SGuTtY9yrytx/css
...
function PlasmicPosts__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__imC3F)}>
        <p.PlasmicLink
      ...
      >
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__pzNjB)}
        >
