...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: 0yhLkRbRp4aL/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__pmCp5)}
              role={"img"}
            />
          ),
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__mbt2S)}
              role={"img"}
            />
          ),
