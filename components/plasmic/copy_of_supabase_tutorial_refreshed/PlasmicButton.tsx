...
import sty from "./PlasmicButton.module.css"; // plasmic-import: 2cx-U1hY5Rzc/css
  ...
  const stateSpecs: Parameters<typeof p.useDollarState>[0] = React.useMemo(
    () => [
      ...
      },
      {
        ...
        type: "private",
        variableType: "variant",
        initFunc: ({ $props, $state, $queries, $ctx }) => $props.hideLabel
      }
    ],
    [$props, $ctx, $refs]
  );
    ...
    <div
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.roothideLabel]: hasVariant($state, "hideLabel", "hideLabel"),
          ...
          [sty.rootshape_bordered]: hasVariant($state, "shape", "bordered"),
    ...
    >
      <p.Stack
        ...
        className={classNames(projectcss.all, projectcss.button, sty.button, {
          ...
          [sty.buttonhideLabel]: hasVariant($state, "hideLabel", "hideLabel"),
          ...
          [sty.buttonshape_borderedRedOnHover_hideLabel]:
            ...
            hasVariant($state, "shape", "borderedRedOnHover"),
          [sty.buttonshape_bordered]: hasVariant($state, "shape", "bordered"),
          [sty.buttonshape_bordered_hideLabel]:
            hasVariant($state, "hideLabel", "hideLabel") &&
            hasVariant($state, "shape", "bordered"),
          ...
          [sty.buttonshowStartIcon_shape_borderedRedOnHover]:
            hasVariant($state, "shape", "borderedRedOnHover") &&
            hasVariant($state, "showStartIcon", "showStartIcon"),
          [sty.buttonshowStartIcon_shape_borderedRedOnHover_hideLabel]:
            hasVariant($state, "hideLabel", "hideLabel") &&
            hasVariant($state, "shape", "borderedRedOnHover") &&
            hasVariant($state, "showStartIcon", "showStartIcon"),
          [sty.buttonshowStartIcon_shape_bordered]:
            hasVariant($state, "shape", "bordered") &&
            hasVariant($state, "showStartIcon", "showStartIcon"),
          [sty.buttonshowStartIcon_shape_bordered_hideLabel]:
            hasVariant($state, "hideLabel", "hideLabel") &&
            hasVariant($state, "shape", "bordered") &&
            hasVariant($state, "showStartIcon", "showStartIcon"),
          ...
          [sty.buttonsize_minimal_color_link]:
            hasVariant($state, "color", "link") &&
            hasVariant($state, "size", "minimal")
        })}
      >
        {(
          ...
          >
            {p.renderPlasmicSlot({
              defaultContents: (
                <ChecksvgIcon
                  className={classNames(projectcss.all, sty.svg__d5Hjx)}
                  role={"img"}
                />
              ),
        ...
        {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
          ...
          >
            {p.renderPlasmicSlot({
              defaultContents: (
                <Icon3Icon
                  className={classNames(projectcss.all, sty.svg__b1QyO)}
                  role={"img"}
                />
              ),
